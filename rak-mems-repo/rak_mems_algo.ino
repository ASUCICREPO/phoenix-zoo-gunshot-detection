...
uint8_t nodeDeviceEUI[8] = {0xAC, 0x1F, 0x09, 0xFF, 0xFE, 0x06, 0x77, 0x20}; // Enter DevEUI
uint8_t nodeAppEUI[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; // Enter AppEUI
uint8_t nodeAppKey[16] = {0x62, 0x54, 0x44, 0x27, 0x58, 0x01, 0x02, 0xF0, 0xBC, 0x13, 0x14, 0x1A, 0x58, 0x07, 0x55, 0x72}; // Enter AppKey
...
//  dtostrf(bat_val,5,2,(char*)mydata);
